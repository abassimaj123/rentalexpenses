...
class _CrossPromoCardState extends State<CrossPromoCard> {
  ...
  static const _prefKey       = 'cross_promo_dismissed_rentalexpenses';
  static const _targetName    = 'Property ROI Suite';
  static const _targetTagline = 'Real estate investment returns';
  static const _targetId      = 'com.calcwise.propertyroisuite';
  static const _accentColor   = Color(0xFFDC6F0A);
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          child: Icon(Icons.apartment_outlined, color: _accentColor, size: 22),
        ),
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            Text('Also from us', style: TextStyle(fontSize: 10, color: CalcwiseTheme.of(context).textSecondary)),
          ]),
          const SizedBox(height: 2),
          const Text(_targetName, style: TextStyle(
              fontSize: 13, fontWeight: FontWeight.w600, color: CalcwiseTheme.of(context).textPrimary)),
